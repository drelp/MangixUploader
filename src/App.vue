<template>
  <div id="app">
    <el-container class="mangix-container">
      <el-header class="mangix-header">
        <span style="color: aliceblue;font-size: x-large">MangixUploader</span>
      </el-header>
      <el-container>
        <el-aside>
